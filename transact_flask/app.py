...
cur.execute( 
    ...
    ('Jimmy@sandiego.edu', 'Jimmy',  TRUE), 
    ('Humpfre@sandiego.edu', 'Humpfre', FALSE), 
    ('Diego@sandiego.edu', 'Diego', FALSE);''') 
cur.execute( 
    '''INSERT INTO Post (contents, user_id, created_at) VALUES \ 
    ('What's your favorite color?', 1, '2024-11-13 01:01:01'), 
    ('Anyone finish their project already?', 2, '2024-11-14 23:59:59');''') 
cur.execute( 
